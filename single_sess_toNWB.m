...
function [beep_ts, click_ts, pass_l, pass_r, pass_white] = PassiveStim()
    ...
    pb_data = uint8(ones(length(pass_beeps), 1));
    ...
    pc_data = uint8(ones(length(pass_clicks), 1));
   ...
   % passive visual times
    ...
    pc_data = uint8(ones(length(pass_noise), 1));
...
function nwb_file = ClustersSpikes(nwb_file, group_view)
    ...
    nwb_file.units = types.core.Units( ...
        ...
        'electrode_group', types.hdmf_common.VectorData('data', electrodes_group_view', ...
        ...
        'electrodes', types.hdmf_common.DynamicTableRegion('table', electrodes_object_view', ...
                     ...
                     'data', waveform_chans'), ...
        'waveform_mean', types.hdmf_common.VectorData('data', permute(waveform, [3, 2, 1]), ...
                        'description',{'Waveform mean'}), ...
        'peakchannel', types.hdmf_common.DynamicTableRegion('table', electrodes_object_view, ...
